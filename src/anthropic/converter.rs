...
mod tests {
    ...
    #[test]
    fn test_map_model_opus_4_7_variants_use_explicit_4_7_target() {
        assert_eq!(
    ...
    #[test]
    fn test_map_model_opus_4_8_variants_use_explicit_4_8_target() {
        assert_eq!(
    ...
    #[test]
    fn test_map_model_preserves_local_unknown_version_fallbacks() {
        assert_eq!(
            map_model("claude-sonnet-4-20250514"),
            Some("claude-sonnet-4.5".to_string())
        );
